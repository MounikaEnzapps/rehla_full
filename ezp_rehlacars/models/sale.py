...
class ResPartner(models.Model):
    ...
    passenger_name = fields.Text('Passenger Name')
    passenger_names = fields.Text('Passenger Name New')
    reh_driver_id = fields.Integer('Driver Id')

    # @api.constrains('passenger_name','reh_driver_id','passenger_id')
    # def onchange_passenger_name(self):
    #     if self.name:
    #         print('fdgdgfdgdfhfhf')
    #         self.passenger_names = self.name.decode()
